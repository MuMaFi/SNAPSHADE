...
$('bWeiterPool').addEventListener('click', () => location.href = './poolrooms/index.html');
   ...
   ist es ein Spiel: ein Eintrag, ein Titelbild, eine Auswahl. */
{
  ...
  const baender = [
    { knopf: $('bEbene1'), schluessel: 'ft_ebene1', ziel: './poolrooms/index.html', vor: 'EBENE 0' },
    { knopf: $('bEbene2'), schluessel: 'ft_ebene2', ziel: './wiese/index.html',     vor: 'EBENE 1' }
  ];
